import{m as r}from"./glowCursor-CBY4duUr.js";import{m as n,a as l,b as c,c as d,d as v,e as p,f as m,g as u}from"./footer-BH-GojY2.js";import{m as h}from"./gallery-Bh2buXfx.js";const i={eyebrow:"PROJECT 02 — SPORTS & LEISURE VENUE",title:"The",titleSub:"Rink",role:"Frontend Lead",desc:"An informational and booking platform for a Moscow sports complex — ice rink in winter, padel, tennis and outdoor activities in summer. Features an events calendar, interactive venue map with seasonal switching, ticket purchase and gift certificate flows.",liveHref:"https://therink.ru/"},g=[["06:00","ice","","ice","","ice","hockey"],["08:00","figure","figure","","figure","figure","hockey"],["10:00","maint","ice","ice","maint","","ice"],["12:00","hockey","","hockey","ice","hockey","figure"]],f=[{val:"94%",lbl:"Occupancy today"},{val:"38",lbl:"Active bookings"},{val:"4.2",lbl:"Revenue today"}],a={label:"NEW BOOKING",sub:"Rink · 14:00"},b=["MON","TUE","WED","THU","FRI","SAT"];function k([e,...s]){return`
