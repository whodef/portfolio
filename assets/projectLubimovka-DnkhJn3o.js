import{m as i}from"./glowCursor-C6XHJMDs.js";import{m as r,a as l,b as n,c as d,d as c,e as u,f as m,g as p}from"./footer-CsnvZlkY.js";import{m as v}from"./gallery-hLI-5Ivb.js";const t={eyebrow:"PROJECT 04 — OPEN-SOURCE CULTURAL PLATFORM",title:"Lubi",titleSub:"movka",role:"Frontend Developer",desc:"A production website for one of Russia's most important contemporary drama festivals — built collaboratively by a distributed team of 20+ developers across 4 frontend squads. I owned the play search feature and author profile pages.",liveHref:"https://lubimovka.art"},s={query:"Searching...",results:[{title:"Unlimited",author:"Чуклинов Максим",year:"2014",city:"Москва"},{title:"Спички детям",author:"Потапова Оля",year:"2020",city:"Санкт-Петербург"},{title:"Пацаны против х**ни",author:"Блинова Нелли",year:"2013",city:"Москва"},{title:"Пустое множество",author:"Брезгунова Екатерина",year:"2015",city:"Москва/Бостон"}]},h=`
<section class="lm-hero">
  <div class="lm-bg"></div>

  <div class="lm-text">
    <div class="lm-eyebrow">${t.eyebrow}</div>
    <h1 class="lm-title">${t.title}<span class="lm-sub">${t.titleSub}</span></h1>
    <div class="lm-role">${t.role}</div>
    <p class="lm-desc">${t.desc}</p>
    <div class="lm-ctas">
        ...
        <div class="lm-content">
          ...
          <div class="lm-search-wrap">
            <div class="lm-search-bar">
              ...
              <span class="lm-search-query">${s.query}</span>
              <span class="lm-search-cursor"></span>
            </div>
            <div class="lm-search-meta">${s.results.length} results found</div>
          </div>
