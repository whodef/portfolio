import{m as z}from"./glowCursor-CBY4duUr.js";const I=[{href:"#hero",label:"//01. &lt;Home/&gt;",side:"left"},{href:"#portfolio",label:"//02. &lt;Portfolio/&gt;",side:"left"},{href:"#press",label:"//03. &lt;Press/&gt;",side:"right"},{href:"#contact",label:"//04. &lt;Contact/&gt;",side:"right"}],F=["hero","portfolio","press","contact"];function O(e){e.innerHTML=`
...
`;function oe(e){e.innerHTML=ie}history.scrollRestoration="manual";window.scrollTo(0,0);z();const ne=document.getElementById("app"),A=document.createElement("div"),G=document.createElement("div"),R=document.createElement("div"),P=document.createElement("div"),V=document.createElement("div");ne.append(A,G,R,P,V);O(A);W(G);Z(R);U(P);oe(V);requestAnimationFrame(()=>window.scrollTo(0,0));
