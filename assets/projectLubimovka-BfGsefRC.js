      ...
      <div class="lm-app">
        ...
        <div class="lm-content">
          ...
          <div class="lm-results">
            ${t.results.map((e,i)=>`
              <div class="lm-result-row" style="animation-delay: ${i*.08}s">
