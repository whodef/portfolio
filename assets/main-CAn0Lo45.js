...
`;function oe(e){e.innerHTML=ie}history.scrollRestoration="manual";window.scrollTo(0,0);O();const ne=document.getElementById("app"),$=document.createElement("div"),A=document.createElement("div"),G=document.createElement("div"),P=document.createElement("div"),N=document.createElement("div");ne.append($,A,G,P,N);j($);W(A);Z(G);U(P);oe(N);requestAnimationFrame(()=>window.scrollTo(0,0));
